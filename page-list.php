	...
	<div id="main" class="clearfix">
		...
		<table>
			<tbody>
				<tr>
					<th>zti_keyword</th>
					<td><?php echo zti_opt('zti_keyword', '未设置');?></td>
				</tr>
        <tr><th>zti_description:</th>
        <td><?php echo zti_opt('zti_description', '未设置');?></td></tr>         
        <tr><th>zti_sitedata:</th>
        <td><?php echo zti_opt('zti_sitedata', '未设置');?></td></tr>         
        <tr><th>zti_sinaurl:</th>
        <td><?php echo zti_opt('zti_sinaurl', '未设置');?></td></tr>         
        <tr><th>zti_weibourl</th>
        <td><?php echo zti_opt('zti_weibourl', '未设置');?></td></tr>         
        <tr><th>zti_qq</th>
        <td><?php echo zti_opt('zti_qq', '未设置');?></td></tr>         
        <tr><th>zti_weixin</th>
        <td><?php echo zti_opt('zti_weixin', '未设置');?></td></tr>         
        <tr><th>zti_qr</th>
        <td><?php echo zti_opt('zti_qr', '未设置');?></td></tr>  
        <tr><th>zti_logo</th>
        <td><?php echo zti_opt('zti_logo', '未设置');?></td></tr>  
        <tr><th>zti_tip</th>
        <td><?php echo zti_opt('zti_tip', '未设置');?></td></tr>  
        <tr><th>zti_tip_text</th>
        <td><?php echo zti_opt('zti_tip_text', '未设置');?></td></tr>  
        <tr><th>zti_tj</th>
        <td><?php echo zti_opt('zti_tj', '未设置');?></td></tr>  
        <tr><th>zti_tjcode</th>
        <td><?php echo zti_opt('zti_tjcode', '未设置');?></td></tr> 
        <tr><th>zti_footbar</th>
        <td><?php echo zti_opt('zti_footbar', '未设置');?></td></tr> 
        <tr><th>zti_index_form</th>
        <td><?php echo zti_opt('zti_index_form', '未设置');?></td></tr> 

        <tr><th>zti_js</th>
        <td><?php echo zti_opt('zti_js', '未设置');?></td></tr>
        <tr><th>zti_gra</th>
        <td><?php echo zti_opt('zti_gra','未设置');?></td></tr>         
        <tr><th>zti_thumb</th>
        <td><?php echo zti_opt('zti_thumb', '未设置');?></td></tr>             
        <tr><th>zti_side_ad</th>
        <td><?php echo zti_opt('zti_side_ad', '未设置');?></td></tr>         
        <tr><th>zti_side_adcode</th>
        <td><?php echo stripslashes(zti_opt('zti_side_adcode', '未设置'));?></td></tr>        
        <tr><th>zti_list_ad</th>
        <td><?php echo zti_opt('zti_list_ad', '未设置');?></td></tr>        
        <tr><th>zti_list_adcode</th>
        <td><?php echo stripslashes(zti_opt('zti_list_adcode', '未设置'));?></td></tr>        
        <tr><th>zti_wap_ad</th>
        <td><?php echo zti_opt('zti_wap_ad', '未设置');?></td></tr>        
        <tr><th>zti_wap_adcode</th>
        <td><?php echo stripslashes(zti_opt('zti_wap_adcode', '未设置'));?></td>
    </tr>        
